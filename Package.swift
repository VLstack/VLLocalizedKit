...
let package = Package(name: "VLLocalizedKit",
                      platforms: [ .iOS(.v17) ],
                      products:
                      [
                       .library(name: "VLLocalizedKit",
                                targets: [ "VLLocalizedKit" ])
                      ],
                      dependencies:
                      [
                       .package(url: "https://github.com/VLstack/VLStringKit",
                                from: "2.0.1")
                      ],
                      targets:
                      [
                       .target(name: "VLLocalizedKit",
